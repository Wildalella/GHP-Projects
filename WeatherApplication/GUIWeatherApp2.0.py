...
SECOND_URL = "http://api.openweathermap.org/data/2.5/air_pollution?"
THIRD_URL = ""
...
URLTWO = SECOND_URL +"zip=" + ZIPCODE +"," + COUNTRY + "&appid=" + API_KEY + "&units=imperial"

response = requests.get(URL)
response2 = requests.get(URLTWO)
